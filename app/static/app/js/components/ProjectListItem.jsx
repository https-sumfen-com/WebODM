...
class ProjectListItem extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      showTaskList:
        props.defaultShowTaskList !== undefined
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.defaultShowTaskList !== this.props.defaultShowTaskList &&
      ...
      this.dz
        ...
        .on("complete", (file) => {
          ...
          const retry = () => {
            ...
            if (!file.accepted) {
              throw new Error(
                interpolate(_("%(filename)s is not a valid file"), {
                  filename: file.name,
                }),
              );
            }
        ...
        <div className="row no-margin">
          ...
          <div className="btn-group project-buttons">
            {this.hasPermission("add") ? (
              <div
                className={
                  "btn-group " + (this.state.upload.uploading ? "hide" : "")
                }
              >
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="hidden-xs">{_("Import")}</span>
                </button>
